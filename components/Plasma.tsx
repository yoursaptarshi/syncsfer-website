...
void mainImage(out vec4 o, vec2 C) {
  ...
  // Reduced iterations for better performance (60 -> 40)
...
export const Plasma: React.FC<PlasmaProps> = ({
  ...
  return <div ref={containerRef} className="w-full h-full absolute inset-0" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, pointerEvents: mouseInteractive ? 'auto' : 'none' }} />;
};
